...
export class BucksService {
  ...
  //Adjust the number of bucks a user has. The changeBucks can be positive or negative. The boolean might be temporary.
  adjustBucks(changeBucks: number): boolean {
    //get the user
